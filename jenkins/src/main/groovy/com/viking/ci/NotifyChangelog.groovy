//package com.meijialove.ci
//
//import com.meijialove.ci.domain.HttpClient
//import com.meijialove.ci.exception.NotifyException
...
//
///**
// * Created by quinlanzhong on 2017/12/12.*/
//class NotifyChangelog {
//
//    static void main(String... args) {
//
//        def accessToken = System.getenv("DT_CHANGELOG_TOKEN")
//        if (accessToken == null || accessToken.isEmpty()) {
//            accessToken = Constant.BACKUP_TEST_TOKEN
//        }
//
//        def dingTitleFile = new File('./dt_test.title')
//        if (!dingTitleFile.exists()) {
//            return
//        }
//        def dingInfoFile = new File('./dt_test.info')
//        if (!dingInfoFile.exists()) {
//            return
//        }
//        def dingTitle = dingTitleFile.getText()
//        def dingInfo = dingInfoFile.getText()
//
